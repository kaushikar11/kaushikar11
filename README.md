...
class Kaushik:
    def __init__(self):
        self.location = "NYC 🗽"
        self.education = "NYU CS Grad Student"
        self.role = "AI Researcher + Full-Stack Engineer"
        self.motto = "If it can be built, I'll build it. If it can't, I'll build it anyway."
        
    def current_focus(self):
        return {
            "research": ["Explainable AI", "Fairness in ML", "Deep Learning"],
            "building": ["AI-powered platforms", "Production-ready systems"],
            "learning": ["Agentic AI", "LLM fine-tuning", "IoT Robotics"],
            "vibe": "Solving problems others think are impossible"
        }
    
    def fun_fact(self):
        return "I've published 3 IEEE papers before graduating undergrad 📄"
```
...
### ⚡ Fun Fact
*I bootstrap startups faster than most people debug their code*

![Visitor Count](https://visitcount.itsvg.in/api?id=kaushikar11&icon=2&color=6)

**"Code is poetry, but production code is a bestseller."** - Me, probably
